...
export class AppointmentComponent implements OnInit {
  ...
  constructor(
    ...
    this.appoinmentForm.valueChanges.subscribe(_change => {
      this.appoinmentData = {
        ...
        service_type: _change.service_type
      };
    })
   }
  ...
  showValidationErrors() {
    ...
    if (this.appoinmentFormControls['service_type'].invalid)
      this.appoinmentFormControls['service_type'].markAsTouched();
...
const serviceType: Array<commonDropdownVM> = [
  { label: "Car Detailing", value: "Car Detailing" },
  { label: "Car Service", value: "Car Detailing" },
];
